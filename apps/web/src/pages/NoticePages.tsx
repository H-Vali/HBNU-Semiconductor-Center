...
export const noticeItems: NoticeItem[] = [
  ...
  },
  {
    id: 'notice-2',
    category: '예약',
    title: '장비 예약 확정 및 취소 기준 안내',
    date: '2026.06.20',
    author: '장비운영팀',
    views: 96,
    pinned: true,
    summary: '교육 이수 장비의 예약 확정과 취소 운영 기준을 안내합니다.',
    body: '장비사용교육 이수와 장비별 권한이 확인된 경우 예약은 즉시 확정됩니다. 예약 취소가 필요한 경우 마이페이지의 내 예약현황에서 진행해주세요.'
  },
  {
    id: 'notice-3',
    category: '교육',
...
export const operationNoticeItems: NoticeItem[] = [
  {
    ...
    body: '장비 공동활용 운영 시간은 평일 기준으로 관리되며, 담당 장비별 교육 이수 및 예약 권한 상태에 따라 사용 가능 여부가 달라질 수 있습니다. 세부 운영 시간은 장비별 담당자 안내를 확인해 주세요.'
  },
  {
